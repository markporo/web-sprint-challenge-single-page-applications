...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   It accesses the match object so that you can route the page to match the desired page.

1. How would you explain form validation to someone who has never programmed before?
   Errors showing when input fields are not fill in or requirements met for those input fields.

1. In 1-2 sentences, define end to end testing.
   The entire user experience of the app, tested so that he journey of the user is flawless.
